...
-- Due to not having time and other stress for getting
-- a job we'll try it some time later and we'll move on
-- to the next topic

-- ****************************************************

-- ---------------------------------------
-- 3RD TOPIC -> DATE FUNCTIONS
-- --------------------------------------- 
...
-- 2. CURDATE -- CURDATE FUNCTION ()

Select curdate();

-- 3. CURTIME -- CURTIME FUNCTION ()
