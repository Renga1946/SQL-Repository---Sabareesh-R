...
-- GRANT, REVOKE - USERS AND PRIVILIGES

Create user "sabareeshjagannathan5"@"127.0.0.1" Identified by 
"welcome123";     
	
Create user "mohammedasif"@"127.0.0.1" Identified by 
"welcome123"; 
  
Create user "venkatkrishnan"@"127.0.0.1" Identified by 
"welcome123"; 

Create user "abhishekpanda"@"127.0.0.1" Identified by 
"welcome123"; 

-- GRANT ACCESS TO SUB ORDINATE USERS

Grant Select on hr.offices to 
"sabareeshjagannathan5"@"127.0.0.1";

Grant update on hr.offices to
"sabareeshjagannathan5"@"127.0.0.1";

Grant alter on hr.offices to
"sabareeshjagannathan5"@"127.0.0.1";



-- GRANTED ACCESS TO OTHER SUB ORDINATE USERS

Grant Select on hr.offices to 
"mohammedasif"@"127.0.0.1";
...
-- ABHISHEK PANDA ACCOUNT

Grant Select on hr.offices to 
"abhishekpanda"@"127.0.0.1";
