...
-- SQUARE FUNCTION EXECUTED VIA POWER FUNCTION
...
-- SQRT () SQUARE ROOT - Finds a root of the SQUARED 
-- value
...
-- ROUND () - rounds off decimal places
...
-- Ceil () or Ceiling () -- It will give us the 
...
-- Mod() -- fetches the REMAINDER value
...
-- 7. RTRIM () -- TRIMS THE BLANK SPACES FROM THE 
-- RIGHT HAND SIDE RTRIM FUNCTION 
-- THAT'S ALL THE PURPOSE

Select Rtrim("       JAGAN NATHAN     ") R_Trimmed;

-- 8. SUBSTRING () -- (str, start_pos[,end_pos])
